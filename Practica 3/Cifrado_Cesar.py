...
while (True):  ##se establece el ciclo infinito
    ...
    if(opcion <= 1):  #primera opcion
        ...
        mensaje_cifrado_y_codificado = descifrado_cesar(txt) #la variable mensaje_cifrado_y_codificado contendra el mensaje descifrado que fue enviado a la funcion descifrado_cesar que contiene el argumento txt
